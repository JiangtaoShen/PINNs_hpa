...
def convection2_2d(num_layers, num_nodes, activation_func, epochs, grid_size, learning_rate, test_name, plotshow = False, device='cpu'):
    ...
    try:
        ...
        num_x_test = 100
        num_y_test = 100
        range_x = torch.tensor([[0., 2 * torch.pi], [0., 2.]]).to(device)
...
# convection2_2d(num_layers=4, num_nodes=54, activation_func='sin', epochs=75800, grid_size=70, learning_rate=0.001, test_name='test', plotshow = True, device='cuda')