...
# pde8: [6 89 'sin' 62350 66 1.608306656787021e-05]
seed = 42
device = 'cuda:0'
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=89, out_dim=1, num_layer=6, activation= 'sin').to(device)
model.apply(init_weights)
epochs = 62350
grid_size = 66
learning_rate = 1.608306656787021e-05
use_lbfgs = False

# Output
output_pkl = f'./output/m1_pde8.pkl'
output_fig_prefix = f"m1_pde8"
