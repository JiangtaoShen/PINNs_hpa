...
# Output
output_pkl = f'./output/m3_pde1.pkl'
output_fig_prefix = f"m3_pde1"
...
# Loss computation
def losses(model, points, b1, b2, b3, b4, points_test, la_pde=1.0, la_bc=1.0, la_ic=1.0):
...
for epoch in tqdm(range(epochs)):
    def closure():
        ...
        total_loss, train_loss_dict = losses(model, region_points, b1, b2, b3, b4, points_test,
                                            la_pde=la_pde, la_bc=la_bc, la_ic=la_ic)
