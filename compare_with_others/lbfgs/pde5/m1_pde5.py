...
# pde5: [6 77 'sigmoid' 25580 24 0.0029933967462308]
seed = 42
device = 'cuda:0'
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=77, out_dim=1, num_layer=6, activation= 'sigmoid').to(device)
model.apply(init_weights)
epochs = 25580
grid_size = 24
learning_rate = 0.002993
use_lbfgs = False

# Output
output_pkl = f'./output/m1_pde5.pkl'
output_fig_prefix = f"m1_pde5"
