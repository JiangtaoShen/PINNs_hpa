...
# pde4: [2 6 'sin' 66348 30 0.0278929263644342]
seed = 42
device = 'cuda:0'
beta = 3
# ----------------------------
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=6, out_dim=1, num_layer=2, activation= 'sin').to(device)
...
# Output
output_pkl = f'./output/m1_pde4.pkl'
output_fig_prefix = f"m1_pde4"
