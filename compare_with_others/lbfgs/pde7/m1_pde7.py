...
# pde7: [4 69 'sigmoid' 93247 120 0.0056520566708974]
seed = 42
device = 'cuda:0'
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=69, out_dim=1, num_layer=4, activation= 'sigmoid').to(device)
...
# Output
output_pkl = f'./output/m1_pde7.pkl'
output_fig_prefix = f"m1_pde7"
