...
# pde1: [4 54 'sin' 75805 65 3.857878400561781e-05]
seed = 42
device = 'cuda:0'
beta = 30
# ----------------------------
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=54, out_dim=1, num_layer=4, activation= 'sin').to(device)
...
# Output
output_pkl = f'./output/m1_pde1.pkl'
output_fig_prefix = f"m1_pde1"
