...
#pde6: [7 77 'swish' 75172 122 0.0006354094803811]
seed = 42
device = 'cuda:0'
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=77, out_dim=1, num_layer=7, activation= 'swish').to(device)
...
# Output
output_pkl = f'./output/m1_pde6.pkl'
output_fig_prefix = f"m1_pde6"
