...
# pde2: [8 74 'swish' 74839 74 0.0013715818189699]
seed = 42
device = 'cuda:0'
rho = 5
# ----------------------------
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=74, out_dim=1, num_layer=8, activation= 'swish').to(device)
...
# Output
output_pkl = f'./output/m1_pde2.pkl'
output_fig_prefix = f"m1_pde2"
