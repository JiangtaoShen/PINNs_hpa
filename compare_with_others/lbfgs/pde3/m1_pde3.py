...
# pde3: [8 83 'swish' 66029 146 0.0002682987912737]
seed = 42
device = 'cuda:0'
...
# ----------------------------
model = PINNs(in_dim=2, hidden_dim=83, out_dim=1, num_layer=8, activation= 'swish').to(device)
...
# Output
output_pkl = f'./output/m1_pde3.pkl'
output_fig_prefix = f"m1_pde3"
